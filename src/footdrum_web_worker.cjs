...
addEventListener('message', async function (e) {
    ...
    console.log(msg);
    // var music = new Audio("https://s3-us-west-2.amazonaws.com/s.cdpn.io/858/outfoxing.mp3");
    // music.play();
    // if (initilaize == 0) {
...
//         drumTrack.disconnect(audioContext.destination);
//         snareTrack.disconnect(audioContext.destination);
